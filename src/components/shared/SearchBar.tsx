...
const SearchBar = () => {
    ...
    <div>
        ...
        <Button className='absolute right-3 top-1/2 -translate-y-1/2 bg-blue-500 text-white px-4 py-1.5
        rounded-lg text-sm h-7 font-medium hover:bg-blue-700 transition--colors duration-200'>
            Search
        </Button>
        </form>
    </div>
